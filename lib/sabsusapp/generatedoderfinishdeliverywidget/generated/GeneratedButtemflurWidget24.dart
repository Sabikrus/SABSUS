...
import 'package:flutterapp/sabsusapp/generatedoderfinishdeliverywidget/generated/GeneratedVuesaxoutlinesmsWidget4.dart';
import 'package:flutterapp/helpers/transform/transform.dart';

/* Instance buttem flur
    Autogenerated by FlutLab FTF Generator
  */
class GeneratedButtemflurWidget24 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () =>
          Navigator.pushNamed(context, '/GeneratedMessegedeliveryWidget'),
      child: Container(
        width: 60.0,
        height: 48.0,
              ...
              return Stack(children: [
                TransformHelper.translate(
                    ...
                    child: Container(
                      width: width,
                      height: height,
                      child: GeneratedVuesaxoutlinesmsWidget4(),
                    ))
              ]);
            }),
          )
