...
import 'package:flutterapp/sabsusapp/generatedmessegedeliverywidget/generated/GeneratedVuesaxoutlinedrivingWidget10.dart';

/* Instance buttem flur
    Autogenerated by FlutLab FTF Generator
  */
class GeneratedButtemflurWidget27 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () =>
          Navigator.pushNamed(context, '/GeneratedOderfinishdeliveryWidget'),
      child: Container(
        width: 60.0,
        height: 48.0,
              ...
              return Stack(children: [
                TransformHelper.translate(
                    ...
                    child: Container(
                      width: width,
                      height: height,
                      child: GeneratedVuesaxoutlinedrivingWidget10(),
                    ))
              ]);
            }),
          )
