...
import 'package:flutterapp/sabsusapp/generatedhomewidget2/generated/GeneratedVuesaxoutlinepercentagesquareWidget8.dart';
import 'package:flutterapp/helpers/transform/transform.dart';

/* Instance buttem flur
    Autogenerated by FlutLab FTF Generator
  */
class GeneratedButtemflurWidget35 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.pushNamed(context, '/GeneratedDiscuntWidget'),
      child: Container(
        width: 60.0,
        height: 48.0,
              ...
              return Stack(children: [
                TransformHelper.translate(
                    ...
                    child: Container(
                      width: width,
                      height: height,
                      child: GeneratedVuesaxoutlinepercentagesquareWidget8(),
                    ))
              ]);
            }),
          )
